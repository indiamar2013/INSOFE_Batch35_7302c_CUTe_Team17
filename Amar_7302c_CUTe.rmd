...
dailyprice_ts <- ts(setdailyprice(fin_train$y1), start = c(2010, 1,1), frequency = 252)
plot(dailyprice_ts)
```
...
plot(arima5_preds)
print(accuracy(arima5_preds, setdailyprice(y1_test$y1)))


```

This model did very well with Training set (MAPE of 1.97) but poorly against the test set where the MAPE was 357.39
